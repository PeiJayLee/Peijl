...
from TW_stock import gettwolist,gettotalvalue,findrate,convertxl,Numbertrans,zeroone,getxlms
...
times=input('請輸入要抓取檔案的時間 格式ex:20190212 :')

start_end_price=input('請輸入stock的價格時間 格式ex:20190212 :')

getxlms.set_time_C(times,'SBL_C')
getxlms.set_time_N(times,"SBL_N")
...
N_price_list=findrate.price_list_maker(N_sid_list,twolistint,start_end_price,start_end_price)
...
price_list_C=findrate.price_list_maker(sid_list_C,twolistint,start_end_price,start_end_price)
...
price_list_N=findrate.price_list_maker(sid_list_N,twolistint,start_end_price,start_end_price)
...
t_site=('http://www.twse.com.tw/SBL/t13sa710?response=json&startDate='+times+'&endDate='+times+'&stockNo=&tradeType=&_=1547881611266')
c_site=('http://www.twse.com.tw/SBL/t13sa710?response=json&startDate='+times+'&endDate='+times+'&stockNo=&tradeType=C&_=1547863612558')
n_site=('http://www.twse.com.tw/SBL/t13sa710?response=json&startDate='+times+'&endDate='+times+'&stockNo=&tradeType=N&_=1547863612558')
...
I_will_always_love_you=zeroone.KaiXuan(zero_check_Val_id,zero_check_Val)
Kiss_kiss_kx=zeroone.Babykaixuan(zero_check_Vol_id,zero_check_Vol)

with open('SBL.text',mode='w', encoding='utf-8') as file:
